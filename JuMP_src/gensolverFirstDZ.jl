...
function gensolverFirstDZ(
    ...
    RgMax ; RgMin #positve; negative # Generator maximum ramp up and ramp down limits
    PgMax ; PgMin #positive;nonnegative # Generator Limits
    c2 ; c1 ; c0 #All nonnegative # Generator cost coefficients, quadratic, liear and constant terms respectively
