...
class transmissionLine(object):
	def __init__(self, idOfTransl, nodeConnt1, nodeConnt2, PowertMax, Reactance, Resistance, scenarioTracker): #constructor begins
		...
		self.resT = Resistance
		self.contScenTracker = scenarioTracker
		#print("\nInitializing the parameters of the transmission line with ID: {}".format(translID))
	...
	def setTranData(self): #member function to set parameter values of transmission lines
	...
	def tpowerangleMessage(self, tRho, Pprevit1, Pnetavg1, uprev1, vprevavg1, Aprevavg1, vprev1,  Pprevit2, Pnetavg2, uprev2, vprevavg2, Aprevavg2, vprev2): #function tpowerangleMessage begins
	...
	def futureMessageBase(self, lambda_TXR, ECoeff, PgNextNu, BSC, ETempCoeff, **lineTempCalc):
		
	def tpowerFutureMessage(self, tRho): # For the upcoming interval, opinions about RND flows		

	def translPower1(self): #function translPower1 begins
		return self.Pt1 #returns the Pt1 iterate
		#function translPower1 ends

	def translPower2(self): #function translPower2 begins
		return self.Pt2 #returns the Pt2 iterate
		#function translPower2 ends

	def calcPtilde1(self): #function calcPtilde1 begins
	...
	def getu2(self): #function getu2 begins
	...
	def calcThetatilde1(self): #function calcThetatilde1 begins
	...
	def calcThetatilde2(self): #function calcThetatilde2 begins
	...
	def calcvtilde1(self): #function calcvtilde1 begins
	...
	def calcvtilde2(self): #function calcvtilde2 begins
	...
	def getv1(self): #function getv1 begins
	...
	def getv2(self): #function getv2 begins
