...
# Include functioninition of Node class 
#include "node.h"
# Include Generator solver class functionintion
profiler = Profiler()
...
julSol.include(os.path.join("JuMP_src", "gensolverFirst.jl")) # functioninition of Gensolver class for base case scenario first interval
julSol.include(os.path.join("JuMP_src", "gensolverFirstBase.jl")) # functioninition of Gensolver class for base case scenario dummy zeroth interval in case of Dummy zero (i.e. gensolver for zeroth interval)
julSol.include(os.path.join("JuMP_src", "gensolverFirstCont.jl")) # functioninition of Gensolver class for contingency case scenario first interval
julSol.include(os.path.join("JuMP_src", "gensolverFirstDZ.jl")) # functioninition of Gensolver class for base case scenario first interval with dummy zero interval
julSol.include(os.path.join("JuMP_src", "gensolverFirstDZCont.jl")) # functioninition of Gensolver class for contingency case scenario first interval with dummy zero interval
julSol.include(os.path.join("JuMP_src", "gensolverSecondBase.jl")) # functioninition of Gensolver class for base case scenario for second interval
julSol.include(os.path.join("JuMP_src", "gensolverSecondCont.jl")) # functioninition of Gensolver class for contingency case scenario for second interval
julSol.include(os.path.join("JuMP_src", "gensolverCont.jl")) # functioninition of Gensolver class for contingency scenario
log.info(("Julia took {:..2f} seconds to start and include LASCOPF models.".format(profiler.get_interval())))
#include "gurobi_c++.h" // includes functioninition of the GUROBI solver header file
